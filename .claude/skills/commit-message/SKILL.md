...
- Types: `feat`, `fix`, `chore`, `docs`, `refactor`, `test`, `style`, `perf`,
  `build`, `ci`, `revert`.
- Scope: the feature of the library the change touches, as the history already
  does — `editor`, `search`, `formly`, `select`, `translate`, `autocomplete`,
  `aggregation`, `theme`, `deps`. Check with
  ...
  scope.
- `!` before the colon marks a breaking change: `feat(editor)!: ...`.
