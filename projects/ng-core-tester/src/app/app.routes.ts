 ...
 */
const canAdd = (): Observable<ActionStatus> => {
  return of({
    // can: Math.random() >= 0.5,
    can: true,
    message: '',
 ...
 */
const canUpdate = (): Observable<ActionStatus> => {
  return of({
    // can: Math.random() >= 0.5,
    can: true,
    message: '',
 ...
 */
const canRead = (): Observable<ActionStatus> => {
  return of({
    // can: Math.random() >= 0.5,
    can: true,
    message: '',
...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('@rero/ng-core').then((r) => r.ngCoreRoutes),
    title: 'Documents',
    data: {
