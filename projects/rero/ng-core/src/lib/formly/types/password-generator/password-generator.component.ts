...
@Component({
  ...
  <p-inputGroup>
    ...
    <p-inputGroupAddon class="core:flex">
      <p-button icon="fa fa-repeat" [title]="'Generate a new password' | translate" (click)="onClick()" severity="secondary" variant="text" />
    </p-inputGroupAddon>
    <p-inputGroupAddon>
      <p-button [icon]="type === 'text'? 'fa fa-eye-slash': 'fa fa-eye'" [title]="'Show or hide password' | translate" (click)="showHidePassword()" severity="secondary" variant="text" />
    </p-inputGroupAddon>
    @if (props.enabledEditMode) {
    <p-inputGroupAddon>
      <p-button [icon]="props.readonly? 'fa fa-lock': 'fa fa-unlock-alt'" [title]="'Edit mode' | translate" (click)="onEdit()" severity="secondary" variant="text" />
    </p-inputGroupAddon>
    }
  </p-inputGroup>
  ...
  `,
  imports: [InputGroup, FormsModule, InputText, ReactiveFormsModule, NgClass, InputGroupAddon, TranslateDirective, TranslatePipe, Button]
})
