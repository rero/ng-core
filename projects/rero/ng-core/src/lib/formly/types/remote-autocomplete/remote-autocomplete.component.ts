...
export class RemoteAutocompleteComponent extends FieldType<FieldTypeConfig<IRemoteAutoCompleteProps>> implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    if (this.props.filters) {
      const optionsObs = this.props.filters.options ?? of([]);
