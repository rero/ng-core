...
describe('withAggregations feature', () => {
  ...
  describe('facetsParameter', () => {
    ...
    it('should return included or filtered aggregations (expanded does not trigger inclusion)', () => {
      ...
      // a2 is expanded but not included — expanded is UI state and does not trigger a search
      expect(store.facetsParameter()).toEqual(['a1', 'a4']);
    });
  });
