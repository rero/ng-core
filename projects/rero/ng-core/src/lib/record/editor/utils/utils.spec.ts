...
import { JSONSchema7, processJsonSchema, resolve$ref } from './utils';
...
describe('EditorUtils', () => {
  ...
  it('Process Json Schema', () => {
    ...
    expect(processJsonSchema(schema as unknown as JSONSchema7)).toEqual(schemaProcessed);
  });
  ...
  it('Resolve $ref definition in jsonschema', () => {
    ...
    expect(resolve$ref(schema as unknown as JSONSchema7, schema.properties)).toEqual(schemaResult);
  });
});
