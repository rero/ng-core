...
export class RecordUiService <TMetadata = JsonObject> {
   ...
   */
  getResourceConfig(type: string): RecordType<TMetadata> {
    if (this.types == null) {
   ...
   */
  redirectAfterSave(pid: string, record: RecordData<TMetadata>, recordType: string, action: string, route: ActivatedRoute): void {
   ...
   * @returns Observable resolving an object containing the result of a permission check.
   */
  canUpdateRecord$(record: RecordData<TMetadata>, type: string): Observable<ActionStatus> {
    const config = this.getResourceConfig(type);
   ...
   * @returns Observable resolving an object containing the result of a permission check.
   */
  canDeleteRecord$(record: RecordData<TMetadata>, type: string): Observable<ActionStatus> {
    const config = this.getResourceConfig(type);
   ...
   * @returns Observable resolving an object containing the result of a permission check.
   */
  canReadRecord$(record: RecordData<TMetadata>, type: string): Observable<ActionStatus> {
    const config = this.getResourceConfig(type);
   ...
   * @returns Observable resolving an object containing the result of a permission check.
   */
  canUseRecord$(record: RecordData<TMetadata>, type: string): Observable<ActionStatus> {
    const config = this.getResourceConfig(type);
